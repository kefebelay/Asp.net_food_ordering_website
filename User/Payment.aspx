<%@ Page Title="" Language="C#" MasterPageFile="~/User/User.Master" AutoEventWireup="true" CodeBehind="Payment.aspx.cs" Inherits="MAKH.User.Payment" %>
            ...
            <div class="row pb-5">
                <div class="col-lg-6 mx-auto">
                    <div class="card ">
                                    ...
                                    <div role="form">
                                        ...
                                        <div class="card-footer">
                                            <asp:LinkButton ID="lbCardSubmit" runat="server" CssClass="subscribe btn btn-info btn-block shadow-sm"
                                                ValidationGroup="card" OnClick="lblCardSubmit_Click">Confirm Payment</asp:LinkButton>
                                        </div>
                                    </div>
                                </div>
                                <!-- End -->
                        ...
                        <div class="card-footer">
                            <b class="badge badge-success badge-pill shadow-sm">Order Total: Birr: <% Response.Write(Session["grandTotalPrice"]); %> </b>
                            <div class="pt-1">
