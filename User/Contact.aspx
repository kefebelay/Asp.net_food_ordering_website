<%@ Page Title="" Language="C#" MasterPageFile="~/User/User.Master" AutoEventWireup="true" CodeBehind="Contact.aspx.cs" Inherits="MAKH.User.Contact" %>
                ...
                <div class="col-md-6">
                    <div class="form_container">
                        ...
                        <div>
                            ...
                            <asp:RequiredFieldValidator ID="rfvSubject" runat="server" ErrorMessage="Email is required" ControlToValidate="txtSubject"
                                ForeColor="Red" Display="Dynamic" SetFocusOnError="true"></asp:RequiredFieldValidator>
                        </div>
                        <div>
                            <asp:TextBox ID="txtMessage" runat="server" CssClass="form-control" placeholder="Enter Feedback"></asp:TextBox>
                            <asp:RequiredFieldValidator ID="rvfMessage" runat="server" ErrorMessage="Message is required" ControlToValidate="txtMessage"
                                ForeColor="Red" Display="Dynamic" SetFocusOnError="true"></asp:RequiredFieldValidator>
                        </div>
