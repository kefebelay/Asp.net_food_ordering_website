<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="Product.aspx.cs" Inherits="MAKH.Admin.Product" %>
                        ...
                        <div class="card p-4">
                            <div class="card-header">   
                                ...
                                <div class = "col-sm-6 col-md-4 col-log-4">
                                    ...
                                    <div class ="form-group ">
                                        <label>Product Price(Birr)</label>
                                        <div>
                                     ...
                                     <div class ="form-group ">
                                         ...
                                         <div>
                                             ...
                                             <asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server" 
                                                 ErrorMessage="Quantity must be above 0" ForeColor="Red" Display="Dynamic"
